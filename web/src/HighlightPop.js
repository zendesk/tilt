...
import "./highlightpop-style.css"

/*
On every mouse up, check if something is is selected
...
class HighlightPop extends Component {
  ...
  onMouseUp = () => {
    ...
    const startNode = selectionRange.startContainer.parentNode.parentNode
    const endNode = selectionRange.endContainer.parentNode.parentNode
